/*
 *    CVParameterSelectionFMeasure.java
 *    
 *    Just like CVParameterSelection, but for F-Measure rather than error rate. 
 *    
 */
...
public class CVParameterSelectionFMeasure extends CVParameterSelection 
implements Drawable, Summarizable, TechnicalInformationHandler {
	...
	throws Exception {
		...
		if (depth < m_CVParams.size()) {
			...
			double error = 1 - evaluation.fMeasure(1);
			if (m_Debug) {
